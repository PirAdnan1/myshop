...
function Footer() {
  return (
    <div className="bg-black">
      <Container>
        <div className="flex flex-col lg:flex-row mt-24 justify-between text-white/75 items-start px-8  pt-6 gap-y-12 lg:gap-0">
        ...
        <p className="bg-black text-white/75 py-14 text-center">
